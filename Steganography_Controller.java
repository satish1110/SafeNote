 ...
 public class Steganography_Controller
{
	...
	private class Decode implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			JFileChooser chooser = new JFileChooser("C:\\Users\\R.Sathish Srinivas\\safe note");
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			if (returnVal == JFileChooser.APPROVE_OPTION)
			{
				...
				try
				{
					...
					{
						JOptionPane.showMessageDialog(view, "The image was encrypted and encoded successfully!", 
	...
	private class DecodeButton implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			System.out.println(stat_path + ", " + stat_name);
				...
				encode_view();
				JOptionPane.showMessageDialog(view, "The image was decoded and decrypted successfully!", 
							"Success!", JOptionPane.INFORMATION_MESSAGE);
